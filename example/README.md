...
- Flutter 3.27+ (the iOS and macOS runners are integrated with Swift Package Manager; on Flutter 3.24–3.34 build with `flutter build` / `flutter run` so Flutter raises the generated plugin package to the app's deployment target).
